...
namespace EmployeeLeaveManagement.Controllers
{
    ...
    public class LeaveAdjustmentEntriesController : Controller
    {
        ...
        {
            ViewData["AdjustmentTypeId"] = new SelectList(_context.DropdownOptions, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,NoOfDays,LeaveAdjustmentDate,LeaveStartDate,LeaveEndDate,AdjustmentTypeId")] LeaveAdjustmentEntry leaveAdjustmentEntry)
        {
            ...
            ViewData["AdjustmentTypeId"] = new SelectList(_context.DropdownOptions, "Id", "Id", leaveAdjustmentEntry.AdjustmentTypeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,NoOfDays,LeaveAdjustmentDate,LeaveStartDate,LeaveEndDate,AdjustmentTypeId")] LeaveAdjustmentEntry leaveAdjustmentEntry)
        {
